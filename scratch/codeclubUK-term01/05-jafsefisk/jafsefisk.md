...
+ Klikk på det blå 'i'{.blockblue}-symbolet igjen, og pass på at figuren bare kan bevege seg fra side til side ved å velge rotasjonsmåte `<-->`.
...
+ Lag en ny figur fra biblioteket ved å bruke __Dyr/Fish2__. 
...
+ Legg merke til at byttet forsvinner uansett hvor det berører JafseFisk. Dessuten kan fisken bare vente 3 sekunder og så spise byttet i samme øyeblikk som det dukker opp igjen, det er ikke særlig rettferdig!
...
__Godt gjort! Du har igrunn fullført spillet! Men det finnes flere muligheter for utvidelse av spillet. Er du klar for en utfordring?__
