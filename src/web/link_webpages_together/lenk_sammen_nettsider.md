...
Dersom du bruker [`<nav>`-taggen](http://www.w3schools.com/tags/tag_nav.asp) fra oppgave [“Del inn nettsiden"](../split_up_website/del_inn_nettsiden.html), så kan du legge lenkene inne i `<nav>`-taggen.
...
Her er et eksempel på 3 sider som er knyttet sammen. Koden er hentet fra [“Del inn nettsiden"](../split_up_website/del_inn_nettsiden.html) hvor vi lære hvordan vi delte inn nettsiden ved hjelp av `<div>`- og `<nav>`-tagger.
## Hjem
