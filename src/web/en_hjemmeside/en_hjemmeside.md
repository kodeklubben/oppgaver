---
title: 1.2 Vi bygger hjemmeside
level: 1
language: nb-NO
---
...
```
`src` er hvor bildet blir hentet fra og hva det heter. I dette tilfellet ligger bildet på samme sted som `om_meg.html` siden den ikke har noe foran filnavnet "katt.png".

`alt` er en tekst som kommer tilsyne dersom bildet ikke vises. Dette kan være hvis nettleseren ikke finner bildet.
