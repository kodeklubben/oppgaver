...
var baseLayers = {
  ...
  'Stamen vannfarger':  L.tileLayer('http://stamen-tiles-{s}.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.{ext}', {attribution: 'Design av <a href="http://stamen.com">Stamen</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Kartdata &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> bidragsytere', subdomains: 'abcd', minZoom: 1, maxZoom: 16, ext: 'png'}),
  'Thunderforest pioneer': L.tileLayer('http://{s}.tile.thunderforest.com/pioneer/{z}/{x}/{y}.png', {attribution: '&copy; <a href="http://www.thunderforest.com/">Thunderforest</a>, &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> bidragsytere'}),
  'Thunderforest transportkart':  L.tileLayer('http://{s}.tile.thunderforest.com/transport-dark/{z}/{x}/{y}.png', {attribution: '&copy; <a href="http://www.thunderforest.com/">Thunderforest</a>, &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> bidragsytere', maxZoom: 19})
}

// Set up map with default layer and control to switch layers
var scratchMap = L.map('kart').setView([65.4, 14], 4);
