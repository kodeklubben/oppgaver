...
Vi skal bygge en kube i minecraft og lære endel viktige klosser i Learn To Mod. Oppgaven er forklart på en detaljert måte og egner seg derfor som den første oppgaven du gjør i Learn To Mod.
...
+ Så må du klikke på **Code** knappen for å komme til kode-siden:
  ...
  Her lager du koden i modden ved å velge fra menyen til venstre.
