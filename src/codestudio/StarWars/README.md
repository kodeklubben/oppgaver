...
__Tema__: Spill, Sekvens, Hendelser (Events)
...
[Klikk her for å se oppgaven.](https://studio.code.org/s/starwarsblocks/stage/1/puzzle/1){target=_blank}
...
- [ ] Det finnes også en versjon av dette kurset som kodes i JavaScript: [Star Wars JavaScript](../StarWarsJs/README.html){target=_blank}
